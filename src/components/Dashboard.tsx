        ...
        <div className="app-container">
            ...
            <main className="content">
                ...
                <div className="top-stats-row">
                    ...
                    <div className="card">
                        <div className="stat-label" style={{ fontSize: '0.75rem', fontWeight: 700, color: '#666', textTransform: 'uppercase', marginBottom: '1rem' }}>Estado Cronológico</div>
                ...
                <div className="main-charts-row-double">
                    ...
                    <div className="card">
                        ...
                        <div className="table-zone-small" style={{ height: '300px', overflowY: 'auto' }}>
                            <table className="compact-detail-table">
                                <thead>
                                    <tr>
                                        <th>Cliente</th>
                ...
                <div className="card">
                    ...
                    <div className="table-wrapper-scroll" style={{ overflowX: 'auto' }}>
